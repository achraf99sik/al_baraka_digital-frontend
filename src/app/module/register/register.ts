          ...
          <div id="signupForm" class="space-y-5">
            <div class="grid grid-cols-2 gap-4">
              <div class="space-y-2">
                ...
                <input
                  type="text"
                  name="firstname"
                  class="input-field w-full px-4 py-3 bg-slate-900/50 border border-slate-700 rounded-xl text-white focus:outline-none focus:ring-0 placeholder-slate-600 text-sm"
            ...
            <div class="space-y-2">
              ...
              <div class="relative">
                ...
                <i
                  class="fa-solid fa-chevron-down absolute right-4 top-3.5 text-slate-500 pointer-events-none"
                ></i>
              </div>
            </div>
            ...
            <p class="text-center text-xs text-slate-500 mt-4">
              Already a member?
              <a routerLink="/login" class="text-cyan-400 hover:text-cyan-300 underline">Sign In</a>
            </p>
          </div>
        </div>
      </main>
